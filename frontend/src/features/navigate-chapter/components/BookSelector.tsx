    ...
    <nav ref={navRef} className="flex items-center gap-1">
      {READER_BOOK_SECTIONS.map((section, sectionIndex) => (
        <div key={section.title} className="flex items-center gap-1">
          {sectionIndex > 0 && (
            <span className="mx-1 h-4 w-px bg-[var(--border)] dark:bg-stone-700" />
          )}
              ...
              <Link
                ...
                className={cn(
                  ...
                  isActive
                    ...
                    : "text-stone-600 hover:text-stone-900 hover:bg-[var(--hover)] dark:text-stone-400 dark:hover:text-stone-100 dark:hover:bg-stone-800",
                )}
              >
